...
class _OrderIndexScreenState extends State<OrderIndexScreen> {
  ...
  void setTitle() {
    context.read<TitleState>().setTitle('Orders');
  }
  ...
  Future<void> fetchData() async {
    ...
    try {
      ...
      IndexResponseModel<List<OrderModel>> response = await OrderAPI.index(
        ...
        children: [
              ...
              SizedBox(
                child: Row(
                  ...
                  children: [
                    ...
                    FilledButton(
                      onPressed: () => context.goNamed('order.create'),
          ...
          Expanded(
            child: ResponsiveGridList(
              ...
              children: data
                  .map((order) => ItemCard(order: order, onDelete: fetchData))
                  .toList(),
            ),
          ),
          const SizedBox(height: 8.0),
...
class ItemCard extends StatefulWidget {
  const ItemCard({super.key, required this.order, required this.onDelete});
...
class _ItemCardState extends State<ItemCard> {
  Future<void> deleteData({required String id}) async {
    await OrderAPI.destroy(params: ShowParamsModel(id: id));
                ...
                children: [
                  InkWell(
                    ...
                    onTap: () {
                      ...
                      context.goNamed('order.read', pathParameters: {
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      showConfirmDialog(
                        ...
                        onYes: () {
                          deleteData(id: widget.order.id.toString());
                          widget.onDelete();
                        },
                      );
                      Navigator.pop(context);
