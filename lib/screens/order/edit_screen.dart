...
class _OrderEditScreenState extends State<OrderEditScreen> {
  ...
  Future<void> fetchData() async {
    ...
    OrderModel? data =
        await OrderAPI.show(params: ShowParamsModel(id: widget.id));
    ...
    if (data?.customer != null) {
      CustomerModel model = CustomerModel.fromJson(data!.customer!.toJson());
    ...
    if (data?.products?.isNotEmpty ?? false) {
      products = List<ProductModel>.from(data!.products!)
          .map(
            (e) => OrderProductModel.form(
              product: ProductModel.form(
                id: e.id,
                name: e.name,
  ...
  Future<void> onSubmit() async {
    ...
    try {
      ...
      await OrderAPI.update(OrderModel.form(
